...
**Product version:** v0.3.0 (Stage 3 — Intent Verification & Scope Analysis)  
...
Sign in with GitHub
      ...
      → Review Decision, Intent & Scope, findings, evidence
...
| **Intent & scope** | Task extraction, classification, creep, coverage, missing work |
...
Next.js (App Router) modular monolith
  ...
  └── Analysis engine
        collect → intent/scope → context → AI → calibrate → decision → persist
