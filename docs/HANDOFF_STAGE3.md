...
| Version narrative | **v0.3.0** — Stage 3 Intent & Scope |
...
| Analysis | Deterministic collect → **intent/scope** → AI → calibrate → **decision** → persist |
...
| `src/lib/analysis/scope/*` | Stage 3 engine |
...
1. **Stage 4** — Productize decision policy (see below)  
...
| [`DECISION_ENGINE.md`](./DECISION_ENGINE.md) | How decisions are made |
...
**Handoff complete.** Continue with: *read `docs/HANDOFF_STAGE3.md` and `docs/ROADMAP.md`, then Stage 4 design or verification.*
