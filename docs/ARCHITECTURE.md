...
| Why did it change? | Stage 3 intent/scope engine |
| What should reviewer care about? | AI findings + merge decision |
...
POST /api/analysis/start
  ...
  → Stage 3: intent extraction + scope verification
...
- `deterministic_result.intentScope` stores Stage 3 payload  
