# Stage 3 — Intent Verification & Scope Analysis — Implementation Report
...
Stage 3 adds a **deterministic intent & scope engine** that runs after changed-file collection and before (and alongside) AI analysis:
...
7. Surface results in a new **Intent & Scope** UI section and feed weak scope into the merge decision.
...
| `analysis-panel.tsx` | Intent & Scope section |
