...
Thanks for helping improve **Agent PR Firewall**. This is a staged portfolio-grade product; keep changes focused and reviewable.
...
- [ ] Docs updated if architecture or stage status changed  
